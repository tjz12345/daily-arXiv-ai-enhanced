...
### [1] [Augmented Analytics and Decision Quality: The Role of Trust among Non-Technical BI Users](https://arxiv.org/abs/2605.20198)
...
### [2] [Evaluating multimodal emotion recognition in proactive conversational agents: A user study](https://arxiv.org/abs/2605.20200)
...
### [3] [GrandGuard: Taxonomy, Benchmark, and Safeguards for Elderly-Chatbot Interaction Safety](https://arxiv.org/abs/2605.20203)
...
### [4] [RealUserSim: Bridging the Reality Gap in Agent Benchmarking via Grounded User Simulation](https://arxiv.org/abs/2605.20204)
...
### [5] [Challenges in Working Towards Patient Engagement in Developing Technology Prototypes](https://arxiv.org/abs/2605.20205)
...
### [6] [PrivacyAkinator: Articulating Key Privacy Design Decisions by Answering LLM-Generated Multiple-choice Questions](https://arxiv.org/abs/2605.20206)
...
### [7] [HealthTale: A Patient-Centric Health Story Visualization Tool](https://arxiv.org/abs/2605.20207)
...
### [8] [Multi-Week, In-Class Deployments of Telepresence Robots With Four Homebound K-12 Students: Benefits, Challenges, and Recommendations](https://arxiv.org/abs/2605.20431)
...
### [9] [Closing the Motivation Gap: Incentives Enhance Visual Misinformation Discernment and Verification](https://arxiv.org/abs/2605.20438)
...
### [10] [Modeling Emotional Dynamics in Agent-to-Agent Interactions on Moltbook](https://arxiv.org/abs/2605.20442)
...
### [11] [Art Card Game (ACG): Embedding Illustration in Gameplay to Mitigate Artist Self-Criticism](https://arxiv.org/abs/2605.20465)
...
### [12] [Creating Learning Scaffolds for Engineering Design Using Concept Catalyst](https://arxiv.org/abs/2605.20511)
...
### [13] [Framing an AI with Values Reduces AI Reliance in AI-supported Writing Tasks](https://arxiv.org/abs/2605.20512)
...
### [14] [Design Principles and Observable Indicators for AI-Enabled Pedagogical Accompaniment: Evidence from the Amico Dual-Mode Prototype in Italy and China](https://arxiv.org/abs/2605.20665)
...
### [15] [CandorMD: An AI-Assisted Audio Simulation and Feedback System for Training Clinicians for Medical Error Disclosure](https://arxiv.org/abs/2605.20701)
...
### [16] [Toward 6G-enabled Brain Computer Interfaces: Technical Requirements, Use Cases, Challenges, and Future Trends](https://arxiv.org/abs/2605.20939)
...
### [17] [The Quiet Path from Seemingly Minor Design Errors to Workplace AI Incidents](https://arxiv.org/abs/2605.21035)
...
### [18] [The Human-AI Delegation Dilemma: Individual Strategies, Collective Equilibria and Sociotechnical Lock-in](https://arxiv.org/abs/2605.21351)
*Angjelin Hila*
...
### [19] [Gen-AI-tecture: using generative AI to support architectural students in design tasks](https://arxiv.org/abs/2605.21361)
*Timo Kapsalis*
...
### [20] [Combating Harms of Generative AI in CS1 with Code Review Interviews and a Flipped Classroom](https://arxiv.org/abs/2605.21374)
...
### [21] [Designing Conversations with the Dead: How People Engage with Generative Ghosts](https://arxiv.org/abs/2605.21390)
...
### [22] [ELSA: An ELastic SNN Inference Architecture for Efficient Neuromorphic Computing](https://arxiv.org/abs/2605.20802)
...
### [23] [Supporting Dynamic Control-Flow Execution for Runtime Reconfigurable Processors](https://arxiv.org/abs/2605.21203)
...
### [24] [SOLAR: A Self-Optimizing Open-Ended Autonomous Agent for Lifelong Learning and Continual Adaptation](https://arxiv.org/abs/2605.20189)
...
### [25] [OSCToM: RL-Guided Adversarial Generation for High-Order Theory of Mind](https://arxiv.org/abs/2605.20423)
...
### [26] [AgentCo-op: Retrieval-Based Synthesis of Interoperable Multi-Agent Workflows](https://arxiv.org/abs/2605.20425)
...
### [27] [High Quality Embeddings for Horn Logic Reasoning](https://arxiv.org/abs/2605.20467)
...
### [28] [\ECUAS{n}: A family of metrics for principled evaluation of uncertainty-augmented systems](https://arxiv.org/abs/2605.20490)
...
### [29] [Open-World Evaluations for Measuring Frontier AI Capabilities](https://arxiv.org/abs/2605.20520)
...
### [30] [AgentAtlas: Beyond Outcome Leaderboards for LLM Agents](https://arxiv.org/abs/2605.20530)
...
### [31] [Personality Engineering with AI Agents: A New Methodology for Negotiation Research](https://arxiv.org/abs/2605.20554)
...
### [32] [Mahjax: A GPU-Accelerated Mahjong Simulator for Reinforcement Learning in JAX](https://arxiv.org/abs/2605.20577)
...
### [33] [From Automated to Autonomous: Hierarchical Agent-native Network Architecture (HANA)](https://arxiv.org/abs/2605.20608)
...
### [34] [COAgents: Multi-Agent Framework to Learn and Navigate Routing Problems Search Space](https://arxiv.org/abs/2605.20618)
...
### [35] [Evaluating Temporal Semantic Caching and Workflow Optimization in Agentic Plan-Execute Pipelines](https://arxiv.org/abs/2605.20630)
...
### [36] [Declarative Data Services: Structured Agentic Discovery for Composing Data Systems](https://arxiv.org/abs/2605.20690)
*Shanshan Ye,Duo Lu*
...
### [37] [VBFDD-Agent for Electric Vehicle Battery Fault Detection and Diagnosis: Descriptive Text Modeling of Battery Digital Signals](https://arxiv.org/abs/2605.20742)
...
### [38] [Conflict-Aware Additive Guidance for Flow Models under Compositional Rewards](https://arxiv.org/abs/2605.20758)
...
### [39] [Interaction Locality in Hierarchical Recursive Reasoning](https://arxiv.org/abs/2605.20784)
...
### [40] [Conditional Equivalence of DPO and RLHF: Implicit Assumption, Failure Modes, and Provable Alignment](https://arxiv.org/abs/2605.20834)
...
### [41] [PlanningBench: Generating Scalable and Verifiable Planning Data for Evaluating and Training Large Language Models](https://arxiv.org/abs/2605.20873)
...
### [43] [For How Long Should We Be Punching? Learning Action Duration in Fighting Games](https://arxiv.org/abs/2605.20911)
...
### [44] [Playing Devil's Advocate: Off-the-Shelf Persona Vectors Rival Targeted Steering for Sycophancy](https://arxiv.org/abs/2605.21006)
...
### [45] [AutoRPA: Efficient GUI Automation through LLM-Driven Code Synthesis from Interactions](https://arxiv.org/abs/2605.21082)
...
### [46] [ScenePilot: Controllable Boundary-Driven Critical Scenario Generation for Autonomous Driving](https://arxiv.org/abs/2605.21168)
...
### [48] [Towards Resilient and Autonomous Networks: A BlueSky Vision on AI-Native 6G](https://arxiv.org/abs/2605.21395)
...
### [51] [Mind the Sim-to-Real Gap & Think Like a Scientist](https://arxiv.org/abs/2605.21458)
...
### [52] [AiraXiv: An AI-Driven Open-Access Platform for Human and AI Scientists](https://arxiv.org/abs/2605.21481)
...
### [53] [DeepWeb-Bench: A Deep Research Benchmark Demanding Massive Cross-Source Evidence and Long-Horizon Derivation](https://arxiv.org/abs/2605.21482)
