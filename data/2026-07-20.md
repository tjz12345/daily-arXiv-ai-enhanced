...
### [2] [Assessing Learning Processes with Multimodal Data in Virtual Reality Learning Environments](https://arxiv.org/abs/2607.15403)
...
### [3] [Interactive 3D Tangible Display with a High-Speed Stiffness-Variable Jamming Module](https://arxiv.org/abs/2607.15325)
...
### [13] [GraphDx: A Cost-Aware Knowledge-Enhanced Multi-Agent Framework for Sequential Diagnosis](https://arxiv.org/abs/2607.15280)
...
### [14] [Causal-Audit: Explicit and Auditable Graph-based Reasoning via Target-Aware Causal Chain Construction](https://arxiv.org/abs/2607.15281)
...
### [15] [AgentFAIR: A Multi-Agent Collaborative Framework for FAIRness Evaluation of Geospatial Datasets](https://arxiv.org/abs/2607.15781)
...
### [19] [DrawingVQA: A Real-World Benchmark for Multi-Depth Visual-Textual Reasoning on Construction Drawings](https://arxiv.org/abs/2607.15418)
...
### [20] [Do Coding Agents Need Executable World Models, Simplification, and Verification to Solve ARC-AGI-3?](https://arxiv.org/abs/2607.15439)
*Sergey Rodionov*
...
### [21] [Beyond a Joke: Multi-Angle Reasoning for Detecting and Explaining Harmful Humor in Memes](https://arxiv.org/abs/2607.15442)
...
### [22] [From Black Box to Executable Logic: Explainable Reinforcement Learning through Prolog Expert Systems](https://arxiv.org/abs/2607.15459)
...
### [23] [A Critical Analysis of Trustworthy AI Tools, Mark Frameworks, and the Implementation Chasms](https://arxiv.org/abs/2607.15480)
...
### [24] [Logic, Optimization, and Artificial Intelligence](https://arxiv.org/abs/2607.15532)
*J. N. Hooker*
...
### [25] [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](https://arxiv.org/abs/2607.15550)
...
### [32] [Knowledge-Centric Agents for Workflow Generation](https://arxiv.org/abs/2607.15845)
...
### [34] [A Formally Grounded ODRL Evaluator: Implementation and Comparison](https://arxiv.org/abs/2607.15987)
...
### [35] [Closing the AI Trust Gap: The Case for Independent Certification for Trustworthy AI](https://arxiv.org/abs/2607.15992)
...
### [36] [SciForge: An AI-Native, Multimodal Workbench for Scientific Discovery](https://arxiv.org/abs/2607.16038)
...
### [37] [Harmonizing AI Safety Thresholds](https://arxiv.org/abs/2607.16112)
...
### [38] [CRAFT: Clustering Rubrics to Diagnose Weak LLM Capabilities and Generate Targeted Fine-Tuning Data](https://arxiv.org/abs/2607.16122)
...
### [39] [RTL-Sequencer: Towards Scalable RTL Timing Prediction with the Sequence-based Paradigm](https://arxiv.org/abs/2607.15830)
...
### [40] [DSTAR: Accelerating Diffusion Transformers via Spatial and Temporal Redundancy Reduction](https://arxiv.org/abs/2607.15846)
...
### [41] [From Patterns to Parsers: Automatic Generation of Efficient Hardware Parsers for FPGAs](https://arxiv.org/abs/2607.16058)
...
### [42] [STAR: Astrocyte-Inspired State-Augmented Repair for Supervised Memristive AI Hardware Systems](https://arxiv.org/abs/2607.15415)
...
### [43] [VaporISAC: Integrated Sensing and Communication via Molecular Signals](https://arxiv.org/abs/2607.15930)
...
### [44] [SQUIRO: A Framework for Security-Aware Quantum-Classical Scheduling on Kubernetes](https://arxiv.org/abs/2607.16089)
...
### [45] [Adaptive Fault Injection Planning for Multi-Layer Self-Healing AI Infrastructure](https://arxiv.org/abs/2607.16161)
