...
### [15] [A Voice-Interactive Multi-Agent System for Smart Operating Rooms: Architecture Design and Key Technologies](https://arxiv.org/abs/2609.11231)
*Tianxiang Zhou*
...
### [17] [The Convention Gap: Towards Measuring Implicit Communication in Cooperative AI Evaluation](https://arxiv.org/abs/2609.11489)
...
### [78] [What Makes Creation Human? Authorship, Reasons, and Meaningful Human Control in Generative AI](https://arxiv.org/abs/2609.10738)
*Yuxi Cao*
...
### [79] ["Coder first, advocate second, college student third": The Liminality of Going to College as a Blind Computing Student](https://arxiv.org/abs/2609.10942)
...
### [80] [ShellVis: Sandboxed Live Programming for Shell Scripts](https://arxiv.org/abs/2609.11000)
...
### [81] [X-Hinges: 3D Printing Self-Sensing Compliant Mechanisms for Continuous and Multi-DOF Motion Sensing](https://arxiv.org/abs/2609.11077)
...
### [82] [Visual-Motion-Induced Modulation of Pedestrian Trajectories Using Spatially Distributed Multi-Display Signage in Public Spaces](https://arxiv.org/abs/2609.11088)
...
### [83] [How AI Coders Discuss, Disagree, and Reach Consensus: Challenges and Opportunities for LLM-Based Qualitative Coding](https://arxiv.org/abs/2609.11109)
...
### [84] [Conceptualising an Initial Design Space for Guidance in Digital Physical Activity Support](https://arxiv.org/abs/2609.11193)
...
### [85] [AI Soccer Analyst: Stage-Aware and Verifiable Human-AI Collaboration for Soccer Data Analysis](https://arxiv.org/abs/2609.11224)
...
### [86] [Are Caption Metrics Broken? Latency, Deaf and Hard of Hearing User Ratings, and Bias across Technologies](https://arxiv.org/abs/2609.11408)
...
### [87] [Design Reflections on Transition to LLM-Aided Novel Visualizations](https://arxiv.org/abs/2609.11503)
*Richard Brath*
...
### [88] [Ethics Training Agents: Facilitating Group-Based Ethics Education with Role-Playing and Discussion for Ethical Reflection and Exploration](https://arxiv.org/abs/2609.11529)
...
### [89] [Bigger than the EAR BOX: A Theory-Grounded Review of XR Accessibility Research for Deaf and Hard of Hearing Communities](https://arxiv.org/abs/2609.11706)
...
### [90] [Understanding Operator Attitudes Toward AI-Supported Decision Making in Maritime Operations](https://arxiv.org/abs/2609.11805)
...
### [91] [MotionQ: Operator-Conditioned Motion Quotients for Cross-Observation WiFi Gesture Recognition](https://arxiv.org/abs/2609.11818)
...
### [92] [REACH: Controller-Managed Long-Span ECC for HBM AI Inference](https://arxiv.org/abs/2609.10861)
...
### [93] [Fengshui: Demystifying Chiplet Ecosystem and Bespoke Neural Network Accelerator Codesign](https://arxiv.org/abs/2609.10970)
...
### [94] [BEACON: A Versatile Accelerator for Computational Pathology Applications](https://arxiv.org/abs/2609.11044)
...
### [95] [Bio-inspired Learning and Decision-Making with Probabilistic In-Memory Computing Hardware: Part 2](https://arxiv.org/abs/2609.11288)
...
### [96] [PATTON: Enabling Commodity PIM for Production LLM Serving](https://arxiv.org/abs/2609.11392)
...
### [97] [CHERI-D Reincarnate: efficient multicore CHERI temporal memory safety through allocation reincarnation (draft version)](https://arxiv.org/abs/2609.11590)
...
### [98] [AccelForge: Comprehensive Modeling and Co-Design Framework for AI Accelerators](https://arxiv.org/abs/2609.11906)
...
### [99] [Fractional-order hardware for neuromorphic computing: Is the order really the problem?](https://arxiv.org/abs/2609.10882)
*Christof Teuscher*
...
### [100] [From Grid to Chip: Power Architecture, Stability, and Flexibility of AI Data Centers](https://arxiv.org/abs/2609.11649)
...
### [101] [A Time-Based Readout for Vector-Matrix Multiplication in Fully Analog Memristive SNNs](https://arxiv.org/abs/2609.11713)
