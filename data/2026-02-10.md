...
### [1] [The Eye-Head Mover Spectrum: Modelling Individual and Population Head Movement Tendencies in Virtual Reality](https://arxiv.org/abs/2602.06164)
*Jinghui Hu,Ludwig Sidenmark,Hock Siang Lee,Hans Gellersen*

Main category: cs.HC

TL;DR: 研究量化了VR中个体头部运动倾向的群体分布，揭示了从眼动主导到头部运动主导的策略谱，并证明倾向性对自适应VR系统设计具有重要意义。


<details>
  <summary>Details</summary>
Motivation: 探索个体在转移视线时头部与眼睛运动的差异倾向，这一现象在HCI领域尚未被充分研究。

Method: 通过360°视频自由观看数据集（N=87）建模头部对视线转移的贡献，并使用基于铰链的参数函数揭示从眼动主导到头部运动主导的策略谱。随后结合360°视频观看和短时控制任务（N=28）进行用户研究。

Result: 参数值在不同任务间存在差异，但个体在群体中的相对位置表现出部分一致性，表明倾向性具有意义但受情境影响。

Conclusion: 研究确立了头部运动倾向作为VR中个体差异的重要维度，并揭示了其对自适应系统（如注视点渲染、视口对齐和多用户体验设计）的潜在影响。
...
### [2] [DataCrumb: A Physical Probe for Reflections on Background Web Tracking](https://arxiv.org/abs/2602.06177)
...
### [3] [Generics in science communication: Misaligned interpretations across laypeople, scientists, and large language models](https://arxiv.org/abs/2602.06190)
*Uwe Peters,Andrea Bertazzoli,Jasmine M. DeJesus,Gisela J. van der Velden,Benjamin Chin-Yee*

Main category: cs.HC

TL;DR: Generics in science communication lead to overgeneralizations, with laypeople and LLMs interpreting them more broadly than scientists, highlighting risks for accurate communication.


<details>
  <summary>Details</summary>
Motivation: To investigate how generics in scientific communication are interpreted differently across audiences and the potential risks of such mismatches.

Method: The study compared interpretations of generics among laypeople, scientists, and two leading LLMs (ChatGPT-5 and DeepSeek).

Result: Laypeople judged scientific generics as more generalizable and credible than scientists, while LLMs rated them even higher, indicating systematic differences in interpretation.

Conclusion: The study highlights the risks of using generics in science communication, as they can lead to overgeneralizations and misinterpretations across different audiences (laypeople, scientists, and LLMs). It underscores the need for more precise language choices in both human and LLM-mediated communication.
...
### [4] [Knowledge Synthesis Graph: An LLM-Based Approach for Modeling Student Collaborative Discourse](https://arxiv.org/abs/2602.06194)
*Bo Shui,Xinran Zhu*
...
### [5] [Personagram: Bridging Personas and Product Design for Creative Ideation with Multimodal LLMs](https://arxiv.org/abs/2602.06197)
...
### [6] [Rethinking External Communication of Autonomous Vehicles: Is the Field Converging, Diverging, or Stalling?](https://arxiv.org/abs/2602.06278)
...
### [7] [Reimagining Legal Fact Verification with GenAI: Toward Effective Human-AI Collaboration](https://arxiv.org/abs/2602.06305)
...
### [8] [How Do Human Creators Embrace Human-AI Co-Creation? A Perspective on Human Agency of Screenwriters](https://arxiv.org/abs/2602.06327)
...
### [9] [InterFlow: Designing Unobtrusive AI to Empower Interviewers in Semi-Structured Interviews](https://arxiv.org/abs/2602.06396)
...
### [10] [Simulating Word Suggestion Usage in Mobile Typing to Guide Intelligent Text Entry Design](https://arxiv.org/abs/2602.06489)
...
### [11] [Personality as Relational Infrastructure: User Perceptions of Personality-Trait-Infused LLM Messaging](https://arxiv.org/abs/2602.06596)
...
### [12] [Beyond Judgment: Exploring LLM as a Support System for Maternal Mental Health](https://arxiv.org/abs/2602.06678)
...
### [13] [PrefIx: Understand and Adapt to User Preference in Human-Agent Interaction](https://arxiv.org/abs/2602.06714)
*Jialin Li,Zhenhao Chen,Hanjun Luo,Hanan Salam*

Main category: cs.HC

TL;DR: Prefix evaluates LLM agents' interaction quality, improving UX by 7.6% and preference alignment by 18.5% through structured tool calls and preference-aware behaviors.


<details>
  <summary>Details</summary>
Motivation: Current benchmarks for LLM-based agents focus on task accuracy but overlook interaction quality, leading to user frustration despite correct task completion. This gap motivates the need for a framework that evaluates and improves how agents interact with users.

Method: The study introduces Prefix, a configurable environment that evaluates both task accuracy and interaction quality using the Interaction-as-a-Tool (IaaT) paradigm. It defines 31 preference settings across 14 attributes and formalizes UX as a core metric. A composite LLM-as-a-Judge mechanism evaluates seven UX dimensions.

Result: The proposed framework achieves strong aggregate reliability (ICC > 0.79), high internal consistency (alpha = 0.943), and human correlation (rho = 0.52-0.78). Preference-aware agents show measurable improvements in UX and preference alignment.

Conclusion: LLM-based agents can significantly improve user experience (UX) by adopting preference-aware interaction patterns, as demonstrated by a 7.6% average UX improvement and 18.5% gain in preference alignment. The work is openly accessible.
...
### [14] [ClassAid: A Real-time Instructor-AI-Student Orchestration System for Classroom Programming Activities](https://arxiv.org/abs/2602.06734)
*Gefei Zhang,Guodao Sun,Meng Xia,Ronghua Liang*

Main category: cs.HC

TL;DR: ClassAid是一个实时协调系统，通过TA Agents和AI仪表板支持教师动态调整AI反馈模式，评估显示其能有效提供个性化反馈。


<details>
  <summary>Details</summary>
Motivation: 生成式AI在教育中的应用引发了不稳定性和过度依赖的担忧，特别是在编程课堂中，需要平衡AI反馈与教师指导。

Method: 开发了ClassAid系统，整合了TA Agents和AI驱动的仪表板，支持教师动态调整AI反馈模式（技术反馈、启发式反馈、自动反馈或无AI支持）。

Result: 评估显示，TA Agents表现良好，54名学生和1名教师的反馈积极，8名教育者的访谈进一步验证了系统的有效性。

Conclusion: ClassAid系统通过动态教师控制AI支持，实现了有效的实时个性化反馈，并为AI在教育环境中的整合提供了设计启示。
...
### [15] [Redundant is Not Redundant: Automating Efficient Categorical Palette Design Unifying Color & Shape Encodings with CatPAW](https://arxiv.org/abs/2602.06792)
...
### [16] [Understanding Workplace Relatedness Support among Healthcare Professionals: A Four-Layer Model and Implications for Technology Design](https://arxiv.org/abs/2602.06916)
...
### [17] [Git for Sketches: An Intelligent Tracking System for Capturing Design Evolution](https://arxiv.org/abs/2602.06047)
...
### [18] [Hear You in Silence: Designing for Active Listening in Human Interaction with Conversational Agents Using Context-Aware Pacing](https://arxiv.org/abs/2602.06134)
...
### [19] [Jackpot: Optimal Budgeted Rejection Sampling for Extreme Actor-Policy Mismatch Reinforcement Learning](https://arxiv.org/abs/2602.06107)
*Zhuoming Chen,Hongyi Liu,Yang Zhou,Haizhong Zheng,Beidi Chen*

Main category: cs.AI

TL;DR: Jackpot框架通过OBRS减少rollout模型与策略间的分布差异，提升RL训练效率与稳定性。


<details>
  <summary>Details</summary>
Motivation: 解决RL在LLMs中因rollout生成与策略优化解耦导致的分布不匹配问题，以提高训练效率和稳定性。

Method: 提出Jackpot框架，整合了OBRS程序、统一的训练目标和高效系统实现（如top-$k$概率估计和批量级偏差校正）。

Result: 实验表明，Jackpot显著提升了训练稳定性，在Qwen3-8B-Base上达到与on-policy RL相当的性能。

Conclusion: 基于OBRS的对齐方法为LLMs的RL训练提供了一种实用且有效的解耦策略，使rollout生成与策略优化更接近实际应用。
...
### [21] [Exposing Weaknesses of Large Reasoning Models through Graph Algorithm Problems](https://arxiv.org/abs/2602.06319)
*Qifan Zhang,Jianhao Ruan,Aochuan Chen,Kang Zeng,Nuo Chen,Jing Tang,Jia Li*

Main category: cs.AI

TL;DR: GrAlgoBench是一个通过图算法问题评估大型推理模型（LRMs）的基准，揭示了LRMs在长上下文推理和过度思考方面的弱点。


<details>
  <summary>Details</summary>
Motivation: 现有的数学、代码和常识推理基准在长上下文评估、挑战性和程序化验证答案方面存在不足。

Method: 引入GrAlgoBench基准，通过图算法问题评估LRMs。这些问题特别适合探究推理能力，因为它们需要长上下文推理、允许细粒度控制难度级别，并支持标准化、程序化评估。

Result: 系统实验揭示了当前LRMs的两大弱点：随着上下文长度的增加准确性下降，以及过度思考现象。

Conclusion: GrAlgoBench通过图算法问题揭示了当前大型推理模型（LRMs）的两大主要弱点：随着上下文长度的增加，准确性急剧下降，以及存在过度思考现象。这为LRMs的研究提供了一个严格、多维且实际相关的测试平台。
...
### [22] [Trifuse: Enhancing Attention-Based GUI Grounding via Multimodal Fusion](https://arxiv.org/abs/2602.06351)
*Longhui Ma,Di Zhao,Siwei Wang,Zhao Lv,Miao Wang*

Main category: cs.AI

TL;DR: Trifuse is an attention-based GUI grounding framework that integrates spatial anchors, OCR, and caption semantics, reducing reliance on annotated data while improving performance.


<details>
  <summary>Details</summary>
Motivation: Existing approaches rely on fine-tuning multimodal large language models (MLLMs) using large-scale GUI datasets, which is data-intensive and generalizes poorly to unseen interfaces. Attention-based alternatives suffer from low reliability due to the lack of explicit and complementary spatial anchors in GUI images.
...
Result: Extensive evaluations on four grounding benchmarks demonstrate that Trifuse achieves strong performance without task-specific fine-tuning.

Conclusion: Trifuse achieves strong performance without task-specific fine-tuning, substantially reducing the reliance on expensive annotated data.
...
### [23] [Difficulty-Estimated Policy Optimization](https://arxiv.org/abs/2602.06375)
...
### [24] [Unlocking Noisy Real-World Corpora for Foundation Model Pre-Training via Quality-Aware Tokenization](https://arxiv.org/abs/2602.06394)
*Arvid E. Gollwitzer,Paridhi Latawa,David de Gruijl,Deepak A. Subramanian,Adrián Noriega de la Colina*

Main category: cs.AI

TL;DR: QA-Token 是一种质量感知的分词方法，通过双层优化和强化学习显著提升了在噪声数据上的性能，并在多个领域取得了突破性成果。


<details>
  <summary>Details</summary>
Motivation: 现有的分词方法未考虑信号质量，限制了其在噪声真实世界语料库上的有效性。QA-Token 旨在通过质量感知的分词方法解决这一问题。

Method: QA-Token 提出了一种双层优化框架，结合了强化学习方法和 Gumbel-Softmax 松弛的自适应参数学习机制，实现了端到端的优化。

Result: 实验结果表明，QA-Token 在基因组学（变体调用 F1 分数提升 6.7 个百分点）和金融（夏普比率提升 30%）等领域表现优异，并在基础规模上实现了最先进的病原体检测（94.53 MCC），同时减少了 15% 的标记数量。

Conclusion: QA-Token 通过将数据可靠性直接纳入词汇构建，显著提升了在噪声真实世界语料库上的性能，并在多个领域（如基因组学和金融）取得了显著的改进。
...
### [25] [Intrinsic Stability Limits of Autoregressive Reasoning: Structural Consequences for Long-Horizon Execution](https://arxiv.org/abs/2602.06413)
*Hsien-Jyh Liao*

Main category: cs.AI

TL;DR: 本文揭示自回归架构在长时程推理中的固有稳定性限制，提出离散分段或图状结构是维持推理链稳定的关键，并指出短时程评估可能掩盖结构不稳定性。


<details>
  <summary>Details</summary>
Motivation: 尽管大语言模型（LLMs）展现出强大的推理能力，但其在长时程任务中性能急剧下降的现象尚未得到完整解释。本文旨在揭示自回归执行的内在稳定性限制，而非仅归因于任务复杂性。

Method: 通过理论推导（如定理A）和实证研究（合成环境及真实TextWorld任务）验证自回归生成的过程级不稳定性对长时程推理的影响。

Result: 理论证明单路径自回归推理中的决策优势随执行长度呈指数衰减；实证结果与理论预测一致，显示性能断崖现象。

Conclusion: 本文的研究结果表明，自回归架构在长时程推理中存在固有的稳定性限制，需要通过离散分段或图状执行结构（如有向无环图）来维持推理链的稳定性。未来的推理系统可能需要从单纯扩展规模转向结构化治理。
...
TL;DR: A 4B-parameter agent model, AgentCPM-Explore, overcomes edge-scale model bottlenecks through a novel training framework, achieving SOTA performance and outperforming larger models in benchmarks.


<details>
  <summary>Details</summary>
Motivation: To explore the underexplored potential of edge-scale models by addressing three primary bottlenecks: catastrophic forgetting during SFT, sensitivity to reward signal noise during RL, and reasoning degradation in long-context scenarios.

Method: The paper introduces AgentCPM-Explore, a 4B-parameter agent model, alongside a holistic training framework featuring parameter-space model fusion, reward signal denoising, and contextual information refinement.

Result: AgentCPM-Explore achieves SOTA performance among 4B-class models, matches or surpasses 8B-class SOTA models on four benchmarks, and outperforms larger-scale models like Claude-4.5-Sonnet or DeepSeek-v3.2 in five benchmarks. It also achieves 97.09% accuracy on GAIA text-based tasks under pass@64.

Conclusion: AgentCPM-Explore demonstrates that edge-scale models can achieve state-of-the-art performance when addressing key bottlenecks like catastrophic forgetting, reward signal noise, and reasoning degradation. The framework's success suggests that inference stability, not inherent capability, is the primary limitation for such models.
...
TL;DR: ScaleEnv是一个从零开始构建完全交互式环境和可验证任务的框架，通过程序化测试和任务验证提升智能体性能，证明了环境多样性对学习的重要性。


<details>
  <summary>Details</summary>
Motivation: 为了解决交互式环境稀缺和现有合成方法在环境多样性和可扩展性方面的局限性，提出了ScaleEnv框架。

Method: ScaleEnv通过程序化测试确保环境可靠性，并通过工具依赖图扩展和可执行动作验证保证任务完整性和可解性。

Result: 在$τ^2$-Bench和VitaBench等未见过的多轮工具使用基准测试中表现出显著的性能提升，证明了智能体的强泛化能力。

Conclusion: ScaleEnv框架通过程序化测试和任务完整性验证，显著提升了智能体在未见过的多轮工具使用基准测试中的表现，证明了环境多样性对智能体学习的重要性。
...
TL;DR: A game-theoretic framework for LLM behavior prediction and steering via Nash equilibrium, avoiding subpopulation exclusion.


<details>
  <summary>Details</summary>
Motivation: The motivation is to predict and steer the behavior of populations of large language models (LLMs) through Nash equilibrium analysis, addressing issues like political exclusion and pathologies in subpopulations.

Method: The method involves a game-theoretic framework using Nash equilibrium analysis, modeling agents' actions as mixtures over human subpopulations, and deriving closed-form NE characterizations.

Result: The results show that the method can avoid political exclusion and pathologies in subpopulations, providing actionable guidance for shifting alignment targets toward socially desirable outcomes.

Conclusion: The paper concludes by illustrating the promise of applying the game-theoretic framework to regulate multi-agent LLM dynamics, avoiding political exclusion and pathologies in subpopulations.
...
### [40] [Agentic Uncertainty Reveals Agentic Overconfidence](https://arxiv.org/abs/2602.06948)
