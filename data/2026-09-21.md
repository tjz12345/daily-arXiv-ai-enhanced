...
### [6] [Can Agents Design Better Chips with a Higher Level Abstraction?](https://arxiv.org/abs/2609.21157)
...
### [7] [Detecting Hallucination in LLMs: Tracing the Topological Signatures of Impaired Context Sharing](https://arxiv.org/abs/2609.21096)
...
### [8] [Decoupling Internal Representational Changes and Causal Importance in Fine-Tuned Large Language Models](https://arxiv.org/abs/2609.21113)
...
### [9] [TinyCeNN-LM: Quality-Gated Conversion of Pretrained Attention with CeNN-Inspired Cellular-Recurrent Layers](https://arxiv.org/abs/2609.21139)
...
### [10] [Clinician-Grounded Quality Assurance for AI-Assisted Psychiatric Intake](https://arxiv.org/abs/2609.21149)
...
### [25] [Reducing Barriers to Academic Support: Evaluating a Course-Specific RAG System for Addressing Help-Seeking Disparities in Higher Education](https://arxiv.org/abs/2609.21600)
...
### [26] [Risk-Aware Occupancy for Safety-Oriented End-to-End Autonomous Driving](https://arxiv.org/abs/2609.21470)
...
### [27] [Driving on Registers, Reasoning on Risk: Risk-Aware Occupancy for Register-Based End-to-End Autonomous Driving](https://arxiv.org/abs/2609.21486)
...
### [28] [LogicTrack: Auditing Reasoning Trajectories of Large Language Models with Formal Logic Solvers](https://arxiv.org/abs/2609.21492)
...
### [29] [PolyBridgeBench: Benchmarking Multimodal LLMs for Physics-Grounded Bridge Design](https://arxiv.org/abs/2609.21493)
...
### [30] [The Communication Bottleneck: A Round-Trip Study of Tree-Structured Expression Serialization in Language Models](https://arxiv.org/abs/2609.21509)
...
### [31] [Learning-to-Optimize as the Missing Architectural Layer of AI-Native Networks](https://arxiv.org/abs/2609.21519)
...
### [32] [Dual-Interest Sequential Product Recommendation With Multi-Granular SSM](https://arxiv.org/abs/2609.21548)
...
### [33] [Beyond Accuracy: Centroid-Guided Contrastive Loss for Structured Fraudulent Job Posting Detection](https://arxiv.org/abs/2609.21599)
...
### [44] [AutoRecLab: Describe the Experiment, Get the Code!](https://arxiv.org/abs/2609.21863)
...
### [45] [What Should We Ask Next? Retrieval-Aware Question Learning under Partial Evidence](https://arxiv.org/abs/2609.21924)
...
### [47] [Learning Cardiac Features: ECG Biometrics Across Time and~Exercise](https://arxiv.org/abs/2609.21962)
...
### [48] [A Lie Detector Test for Language Models: Reading Knowledge a Model Won't Reveal](https://arxiv.org/abs/2609.21996)
*Hiskias Dingeto*
...
### [49] [CodeMidas: Scaling Agentic Coding RL Environments from Code Itself](https://arxiv.org/abs/2609.22068)
...
### [50] [Designer-RSI: Evolving Procedural Memory from User Traffic for Agentic Graphic Design](https://arxiv.org/abs/2609.22086)
...
### [51] [Trustworthy FinAInce: Unpacking How AI-Mediated Financial Advice is Judged](https://arxiv.org/abs/2609.20989)
...
### [52] [Understanding How Educators Configure GenAI Support for Open-Ended Learning -- An Exploratory Study of K-12 Career Exploration](https://arxiv.org/abs/2609.21019)
...
### [53] [Decoding the Dashboard: Data Comics to Support Students' Understanding of Learning Analytics Visualisations](https://arxiv.org/abs/2609.21141)
...
### [54] [Exploring Text Classification Models with Sparse Autoencoders](https://arxiv.org/abs/2609.21142)
...
### [55] [Human Driver Temperament and the Safety Impact of a C-V2X Denial-of-Service Flooding Attack in Mixed-Autonomy Traffic](https://arxiv.org/abs/2609.21206)
...
### [56] [Self-Care and Mental Health: Mapping Over A Decade of HCI Interventions](https://arxiv.org/abs/2609.21239)
...
### [57] [Two's a Crowd: Human and AI-Based Copresence for Developers with ADHD](https://arxiv.org/abs/2609.21254)
...
### [58] [GUIDE: Designer-in-the-loop Authoring of Conformant Generative User Interfaces](https://arxiv.org/abs/2609.21285)
...
### [59] [AESSI: An Around-Ear Silent Speech Interface for Cross-Day Online Reuse without Test-Day Calibration](https://arxiv.org/abs/2609.21436)
...
### [60] [People escalate against a competitor labelled human and hold back against one labelled an optimising machine](https://arxiv.org/abs/2609.21439)
...
### [61] [Do We Care About Personalization and Explainability? An Interview Study with News Recommendation Engineers](https://arxiv.org/abs/2609.21547)
...
### [62] [Notrix: Understanding Machine Learning Solutions Across Computational Notebooks at Scale](https://arxiv.org/abs/2609.21775)
...
### [63] [Comparing Hand and Controller Avatars with Hand Tracking and Controller-Based Interaction](https://arxiv.org/abs/2609.21799)
...
### [64] [An Agentic Just-in-Time Adaptive Intervention System for Personalized Sleep Support: Proof-of-Concept Study with N of 1 Data](https://arxiv.org/abs/2609.21805)
...
### [65] [Touvigation: Embodied Adaptive Object Acquisition for Blind and Low-Vision Users in Unfamiliar Indoor Environments](https://arxiv.org/abs/2609.21828)
...
### [66] [Beyond Counting Blessings: Tracing the Evolution of Gratitude Practices and Technology Needs](https://arxiv.org/abs/2609.21853)
...
### [67] [Comparing Haptic Feedback Across Hand Tracking and Controllers in VR Object Interaction Tasks](https://arxiv.org/abs/2609.21869)
...
### [68] [Depressive symptoms are reflected differently across digital contexts](https://arxiv.org/abs/2609.21919)
...
### [69] [Can I Trust My Body? A Three-Year Autoethnography of ChatGPT's Place in My Support System for Panic Attacks](https://arxiv.org/abs/2609.21925)
...
### [70] [Beyond Reactive Assistance: PV-Care Using Low-Density EEG and AI to Provide Proactive, Context-Aware Help for MCI](https://arxiv.org/abs/2609.22024)
...
### [71] [Gricea: An Open Science Platform for Conversational AI Research](https://arxiv.org/abs/2609.22039)
...
### [72] [Value-Sensitive Delegation in Everyday AI Agent Use: Evidence from OpenClaw](https://arxiv.org/abs/2609.22067)
...
### [73] [A Sociotechnical Review of Algorithms in Health Systems: Technical, Cost, and Human-Centered Considerations](https://arxiv.org/abs/2609.22070)
...
### [74] [A Multi-Engine Dataflow for MoE Decoding on Scratchpad-Based Tensor Accelerators](https://arxiv.org/abs/2609.21137)
...
### [75] [Programming AMD XDNA NPUs with Open-source Compiler Tools: A FlashAttention Case Study](https://arxiv.org/abs/2609.21264)
...
### [76] [Integrating Approximate Logic Synthesis into Approximate High-Level Synthesis](https://arxiv.org/abs/2609.21697)
...
### [77] [Scalable Packet Tracking on FPGAs for Erasure-Coded RDMA over Lossy WANs](https://arxiv.org/abs/2609.21774)
