...
### [34] [Using profiles of cognitive capability to assess AI suitability for workplace tasks](https://arxiv.org/abs/2608.25623)
...
### [56] [User-Centered Design for Digital Patient-Navigation Tools in Oncology: Scoping Review](https://arxiv.org/abs/2608.24887)
...
### [57] [Agentic World Analysis (AWA) - an alternative way to explore systems and support decision making](https://arxiv.org/abs/2608.24896)
...
### [58] [MCP-Driven Accessibility Tree Standardization for AI-Powered Screen Reader Agents](https://arxiv.org/abs/2608.24898)
...
### [59] [aipsy-judge: A Specialized, Psychologist-Corrected Local Judge for the Psychological Safety of Conversational AI](https://arxiv.org/abs/2608.24899)
...
### [60] [Stronger Alignment between Brain Activity and LLM Embeddings during Code Writing compared to Prose Writing](https://arxiv.org/abs/2608.24900)
...
### [61] [Beyond the Chatbot: Co-Learning and Co-Teaching through a Dual-Persona Generative-AI Assistant](https://arxiv.org/abs/2608.24902)
...
### [62] [Evidence-Grounded Mapping of Multimodal Human Sensing Psychological Transdiagnostic Dimensions](https://arxiv.org/abs/2608.24903)
...
### [63] [PARAssist: A Framework for Personalized and Adaptive Robotic Assistance from Ambiguous User Requests](https://arxiv.org/abs/2608.24905)
...
### [64] [PA-CoT: Profile-Adaptive Chain-of-Thought for Personalized Nutritional Consulting](https://arxiv.org/abs/2608.24907)
...
### [65] [Hallucination by proxy in LLM-assisted differential diagnosis](https://arxiv.org/abs/2608.24908)
...
### [66] [Super Star: Towards Streaming Real-time Interactive Agents for Digital Humans](https://arxiv.org/abs/2608.24909)
...
### [67] [From Plots to Words: Model-Aware Multimodal Explanations as a Foundation for Accessible, Non-Visual Interaction](https://arxiv.org/abs/2608.24910)
...
### [68] [Visualizing Patient Trajectories and Disorder Co-occurrences in Child and Adolescent Mental Health](https://arxiv.org/abs/2608.24911)
...
### [69] [Analyzing and Correcting Benevolence Bias in Large Language Models](https://arxiv.org/abs/2608.24912)
...
### [70] [From Blind Edits to Verified Repair: Building Trustworthy User-Side LLM Agents for Web Accessibility](https://arxiv.org/abs/2608.24913)
...
### [71] [AI-Ready Research Workflows in Computational Social Science: Lessons on Building a Shared Language for Interdisciplinary Collaboration](https://arxiv.org/abs/2608.24914)
...
### [72] [What Are We Measuring? Bonding, Trust, and the Evaluation of Human-Robot Relationships](https://arxiv.org/abs/2608.24915)
*Imran Khan*
...
### [73] [Teaching Geometric Proof with Tech: Pitfalls and Possibilities](https://arxiv.org/abs/2608.25117)
...
### [74] [The Systems Paper is Dead. Long Live the Systems Paper](https://arxiv.org/abs/2608.25219)
*Bjoern Hartmann*
...
### [75] ["Am I Just That Dumb?": Applicability, Action and Verification in Consumer IoT Security Advice](https://arxiv.org/abs/2608.25225)
...
### [76] [AVI-Personality: A Trait-Activated Multimodal Dataset for Personality and Competency Assessment in Asynchronous Video Interviews](https://arxiv.org/abs/2608.25316)
...
### [77] [HRGuard: Gating Relationship Manipulation in Multi-Turn Agentic AI Conversations](https://arxiv.org/abs/2608.25340)
...
### [78] [Q&A or Document-Based? The Effects of Interface Type on How Screen Reader Users Access Interconnected Documents](https://arxiv.org/abs/2608.25382)
...
### [79] [TailorCoPilot: Enabling Agentic Pattern Making with Version-Controlled State Tracking](https://arxiv.org/abs/2608.25462)
...
### [80] [ScentEcho: Exploring Adsorbent Materials for Accurate Odor Collection and Playback](https://arxiv.org/abs/2608.25494)
...
### [81] [The Well-Being Palette: An Action-Word Selection Tool Designed for Low-Burden Reflection on Workplace Well-Being](https://arxiv.org/abs/2608.25527)
...
### [82] [Maru: Information Architecture as a Shared Language for Generating Aligned and Persistent User Interfaces](https://arxiv.org/abs/2608.25565)
...
### [83] [Are Concept Bottleneck Models Effective as Decision-Support Systems?](https://arxiv.org/abs/2608.25581)
...
### [84] [AffectSim: A Controllable Interactive 3D Simulation Benchmark for Embodied Affective Perception](https://arxiv.org/abs/2608.25664)
...
### [85] [Large Language Model Few-Shot Prompting with Dilemma Training Outperforms Human Surrogates in Predicting Patient Preferences](https://arxiv.org/abs/2608.25771)
...
### [86] [Do Vision-Language Models Agree on the Affective Qualities of Shape? A Cross-Model Audit for Generative Design Interfaces](https://arxiv.org/abs/2608.25876)
...
### [87] [Gaming Together on Discord: Teen Gamer's Cross-Platform Practices](https://arxiv.org/abs/2608.25942)
...
### [88] [From Producing to Validating: How AI Is Deskilling Freelancers](https://arxiv.org/abs/2608.26089)
*Nakul Rajpal*
...
### [89] [Hydra: Phase-Aware Workload Characterization of LLM Inference across Edge SoC Generations, Backends, and Quantization Levels](https://arxiv.org/abs/2608.25053)
...
### [90] [FLINT: Efficiently Leveraging High Bandwidth Flash for Capacity-Scalable LLM Inference Acceleration](https://arxiv.org/abs/2608.25062)
...
### [91] [An Open-Source Benchmark Suite of 3D-IC Testcases](https://arxiv.org/abs/2608.25155)
...
### [92] [BOOSTEDSOSA: Accelerated Inferencing for Low Variance Stochastic Online Scheduling](https://arxiv.org/abs/2608.25346)
...
### [93] [APT: Accelerating Diffusion Transformers via Attention Probability-Guided Pruning and Quantization](https://arxiv.org/abs/2608.25380)
...
### [94] [Syn2Logic: End-to-End Neuromorphic Design Automation](https://arxiv.org/abs/2608.25536)
*Artur Podobas*
...
### [95] [Integrated Hardware Annealing based on Langevin Dynamics for Ising Machines](https://arxiv.org/abs/2608.26100)
...
### [96] [Simulating Cognitive Smart Freight Corridors with Agent-Based Models and Reinforcement Learning](https://arxiv.org/abs/2608.25193)
...
### [97] [GPU-Accelerated Quantum Annealing-Inspired UAV Path Planning for Smart Agriculture](https://arxiv.org/abs/2608.25376)
...
### [98] [Study of Resistive Switching Dynamics and Memory States Equilibria in Analog Filamentary Conductive-Metal-Oxide/HfOx ReRAM via Compact Modeling](https://arxiv.org/abs/2608.25767)
...
### [99] [Update Disturbance-Resilient Analog ReRAM Crossbar Arrays for In-Memory Deep Learning Accelerators](https://arxiv.org/abs/2608.25781)
...
### [100] [Simultaneous Digital Communication and Deformation Sensing over a Single Stretchable Interconnect](https://arxiv.org/abs/2608.25801)
